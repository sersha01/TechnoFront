...
function Manifest() {
  return (
    <Row className={`m-0 ${style.manifest}`}>
        ...
        <Col className='mt-5 d-flex justify-content-center' xs={12}><Col xs={9}><input type="text" className={`w-100 py-2 rounded-3 ${style.input}`} disabled /></Col></Col>
        <Col className='my-2 d-flex justify-content-center' xs={12}><Col xs={9}><input type="text" className={`w-100 py-2 rounded-3 ${style.input}`} disabled /></Col></Col>
