...
function Profile() {
  return (
    <Row className={`m-0 py-3 rounded-2 ${style.profile}`}>
      ...
      <form className='row m-0'>
        <Col xs={12} className={`py-1 my-1 text-start ps-3 rounded-3 ${style.inputField}`}>
          <label className={`${style.label} p-0 m-0`}>Full name</label>
        ...
        <Col xs={12} md={6} className='my-1 ps-0 pe-1'><Col className={`py-1 text-start ps-3 rounded-3 ${style.inputField}`}>
          <label className={`${style.label} p-0 m-0`}>Domain</label>
          ...
          <Col xs={12} md={6} className='my-1 ps-1 pe-0'><Col className={`py-1 text-start ps-3 rounded-3 ${style.inputField}`}>
            <label className={`${style.label} p-0 m-0`}>Date of Birth</label>
          <input type='text' className={`w-100 ${style.input}`} /></Col></Col>
        <Col xs={12} className={`py-1 my-1 text-start ps-3 rounded-3 ${style.inputField}`}>
          <label className={`${style.label} p-0 m-0`}>Address</label>
          <textarea rows='4' className={`w-100 ${style.input, style.textarea}`} /></Col>
        <Col xs={12} className={`py-1 my-1 text-start ps-3 rounded-3 ${style.inputField}`}>
          <label className={`${style.label} p-0 m-0`}>Education</label>
          <input type='text' className={`w-100 ${style.input}`} /></Col>
        <Col xs={12} className={`py-1 my-1 text-start ps-3 rounded-3 ${style.inputField}`}>
          <label className={`${style.label} p-0 m-0`}>Collage</label>
          <input type='text' className={`w-100 ${style.input}`} /></Col>
        <Col xs={12} className={`py-1 my-1 text-start ps-3 rounded-3 ${style.inputField}`}>
          <label className={`${style.label} p-0 m-0`}>Experience</label>
          <input type='text' className={`w-100 ${style.input}`} /></Col>
        <Col xs={12} className={`py-1 my-1 text-start ps-3 rounded-3 ${style.inputField}`}>
          <label className={`${style.label} p-0 m-0`}>Company</label>
          <input type='text' className={`w-100 ${style.input}`} /></Col>
        <Col xs={12} className={`py-1 my-1 text-start ps-3 rounded-3 ${style.inputField}`}>
          <label className={`${style.label} p-0 m-0`}>Email</label>
          <input type='text' className={`w-100 ${style.input}`} /></Col>
        <Col xs={12} className={`py-1 my-1 text-start ps-3 rounded-3 ${style.inputField}`}>
          <label className={`${style.label} p-0 m-0`}>Mobile</label>
          <input type='text' className={`w-100 ${style.input}`} /></Col>
